...
const DashedLine = (props) => {
  var DashedLineColors = props.data?.colors;
  var series = [
    {
      name: "Total Leads",
      data: props?.data?.data?.total_lead,
    },
    {
      name: "Approved Leads",
      data: props?.data?.data?.approved_leads,
    },
    {
      name: "Total Users",
      data: props?.data?.data?.checkin,
    },
  ];
  var options = {
    chart: {
    ...
    xaxis: {
      categories: props?.data?.data?.hour,
    },
    tooltip: {
      y: [
        {
  ...
  return (
    <React.Fragment>
      <ReactApexChart
        options={props?.data?.type == "3" ? options : options2}
        series={series}
        type="line"
        height="380"
        className="apex-charts"
...
const DashedLine2 = (props) => {
  ...
  var series = [
    ...
    {
      name: "Pending Leads",
      data: props?.data?.data?.pending_leads,
    },
    {
      name: "Rejected Leads",
      data: props?.data?.data?.rejected_leads,
    },
    {
      name: "Total User",
      data: props?.data?.data?.checkin,
  ...
  return (
    <React.Fragment>
      <ReactApexChart
        options={props?.data?.type == "5" ? options : options2}
        series={series}
        type="line"
        height="380"
        className="apex-charts"
...
const DashedLineEp = (props) => {
  // var DashedLineColors = props.data?.colors;
  var series = [
    {
      name: "Total Leads",
      data: props?.data.totalClusterPerformance,
    },
  ];
  var options = {
    chart: {
    ...
    xaxis: {
      categories: props?.data.totalCluster,
    },
    tooltip: {
      y: [
        {
