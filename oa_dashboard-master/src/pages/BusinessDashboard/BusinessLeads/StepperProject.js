...
const StepperProject = ({ rowData }) => {
  ...
  React.useEffect(() => {
    rowData?.project_intro_status == "0" &&
    rowData?.pilot_status == "0" &&
    rowData?.live_status == "0"
      ? toggleTab(1, 0)
      : rowData?.project_intro_status == "1" &&
        rowData?.pilot_status == "0" &&
        rowData?.live_status == "0"
      ? toggleTab(2, 35)
      : rowData?.project_intro_status == "1" &&
        rowData?.pilot_status == "1" &&
        rowData?.live_status == "0"
      ? toggleTab(3, 70)
      : rowData?.project_intro_status == "1" &&
        rowData?.pilot_status == "1" &&
        rowData?.live_status == "1"
      ? toggleTab(4, 100)
      : toggleTab(1, 0);
  }, [rowData]);
